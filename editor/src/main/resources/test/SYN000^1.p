%------------------------------------------------------------------------------
% File     : SYN000^1 : TPTP v7.0.0. Released v3.7.0.
% Domain   : Syntactic
% Problem  : Basic TPTP 
% Version  : Biased.
...
% Status   : Theorem
% Rating   : 0.12 v7.0.0, 0.14 v6.4.0, 0.17 v6.3.0, 0.20 v6.2.0, 0.57 v6.1.0, 0.29 v6.0.0, 0.43 v5.5.0, 0.50 v5.4.0, 0.60 v5.1.0, 0.20 v4.1.0, 0.00 v3.7.0
